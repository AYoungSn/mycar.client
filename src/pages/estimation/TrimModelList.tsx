...
function TrimModelList() {
  ...
  const tooltips = useFetchToolTips(
    ...
    <div>
      ...
      <ContentWrap>
        <div>
          <ToolTips
            tooltips={tooltips}
            onChangeEngineId={(id: number) => {
              setEngineId(id);
            }}
            engineId={engineId}
            onChangeDrivingId={(id: number) => {
              setDrivingId(id);
            }}
            drivingId={drivingId}
            onChangeGearboxId={(id: number) => {
              setGearboxId(id);
            }}
            gearboxId={gearboxId}
          />
        ...
        <TrimWrap>
          {trims &&
            trims.map((trim: Trim) => {
              return <TrimBox trim={trim} carCode={carCode} />;
            })}
        </TrimWrap>
      </ContentWrap>
    </div>
